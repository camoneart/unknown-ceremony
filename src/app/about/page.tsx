const AboutPage = () => {
  return (
    <div
      className="h-full flex flex-col items-center justify-center text-center gap-[35px] pb-[38px]"
      style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.5)' }}
    >
      <section className="max-w-[800px] grid gap-[25px]">
        <h2 className="text-[30px] tracking-[0.2em]">CONCEPT</h2>
        <div className="grid gap-[25px]">
          <p className="text-[18px] font-bold leading-relaxed">
            &quot;無名が制作した作品をWebという大きな会場にて披露する式典&quot;
          </p>
      ...
      <section className="max-w-[800px] grid gap-[25px]">
        <h2 className="text-[30px] tracking-[0.2em]">ABOUT</h2>
